...
**Link(s) to work**:
[Fun MOOC about Python](https://www.fun-mooc.fr/courses/course-v1:UCA+107001+session02/courseware/39f73ecca8274b48b5edc06d00ab259c/3495acace4304b78b11ed18a2641367f)
[List challenge in HackerRank](https://www.hackerrank.com/challenges/python-lists)
...
**Link(s) to work**:
[Fun MOOC about Python](https://www.fun-mooc.fr/courses/course-v1:UCA+107001+session02/courseware/39f73ecca8274b48b5edc06d00ab259c/3495acace4304b78b11ed18a2641367f)
[CodeAcademy](https://www.codecademy.com/courses/learn-python-3/lessons/data-types/exercises/object-oriented-programming)
...
----
### Day 11: January 01, 2020

**Today's Progress**: I finished my codeacademy course on python. It was about arguments in function, positional, optional, default, \*args, and \*\*kwargs. I also tried the exercism.io website and did the first two python exercises.

**Thoughts**: It's hard to work the day after new years eve lol but well, a challenge is a challenge ! I was not feeling the best at learning things today so I preferred to do some exercises. The exercism.io concept is super cool ! You code on your editor and when your code pass the tests that are already written you can then publish on the website, and in the next day a "mentor" is going to review your code for free and you can learn from it ! Super cool !
...
**Today's Progress**: I finished the codeacademy course on git, it was about the commands for working in collaboration git fetch, git branch, git merge, git push. Continiuing my journey to become a deep learning programmer on udacity, I learned new models of neural networks with a sigmoid function, feedforward and backpropagation.
...
- Finished my course on [SQL](https://classroom.udacity.com/courses/ud197).
...
**Thoughts**: This was one of the day before the long break of my challenge
...
**Today's Progress**:
- MITx 14.310x: 2h working on Maximum Likelihood and stuff like that
- I fixed some problems in my app such as adding more validated files type for uploading in the album photo. I also fixed a nasty sqlalchemy filter bug that I created thanks to Flake8. It wanted me to change `== False` to `is False` in a sqlalchemy query filter condition, but bad idea ! SQLAlchemy doesn't understant `is False`, only `== False`! I also fixed some edit album title button that was showing up even for non album owners. I corrected the album public url.

**Thoughts**: I got motivated easily this afternoon, and I was very very happy to end up with a working result ! It took me only 2 days whereas I thought I needed much more time to make it work ahah. I already see a lot of small improvements I can make to this web app like cryptography, anonymize the data, display a countdown before next picture, etc ...
...
**Today's Progress**:
- MITx 14.310x: 2h working on Confidence Interval
- I went back on my 100 Days log maker python app and wanted to make it works with my log file. There is a functionality to update the log file if there is missing days, but unfortunately after 2 hours fixing little bug after little bug I couldn't make it work. The problem is that my log file was not generated at first by this program (because I already had started the challenge at that time) so it doesn't fit perfectly. But I'm on it and it is just a mater of time. My next goal is to make an online version so I can make thing more visual !

**Thoughts**: I find it hard to dedicate time for coding because my morning is dedicated to mathematic, after lunch I do 1h of piano, and then motivation is hard to find sometime, but as soon as I start coding then times flies and I'm so focus ! It feels I like it ! 😆 (I know I like it it's a joke 😜)
